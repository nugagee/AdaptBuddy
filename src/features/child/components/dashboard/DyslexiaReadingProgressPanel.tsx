        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-600 dark:text-gray-400">
              Read or listen to one sentence in Read-Aloud Adventure to begin today&apos;s progress.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="flex min-w-0 items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm font-semibold text-slate-600 dark:text-gray-300">
              {latest.sentencesCompleted} of {latest.totalSentences} sentences completed at {latest.speechRate}x speed.
            </p>
          </div>
        </div>
