        ...
        <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain p-5 sm:p-6">
          ...
          <div className="mb-6">
            ...
            <div className="mb-4 flex gap-3">
              <button
                type="button"
                className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-blue-100 py-3 font-bold text-blue-700 dark:bg-blue-950/50 dark:text-blue-300"
              >
              ...
              <button
                type="button"
                className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-green-100 py-3 font-bold text-green-700 dark:bg-green-950/50 dark:text-green-300"
              >
