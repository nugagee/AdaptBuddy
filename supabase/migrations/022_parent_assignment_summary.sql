-- Parent-facing assignment summary.
-- Keeps parents out of raw teacher assignment tables while still showing the
-- approved child-task-support loop on the parent dashboard.
